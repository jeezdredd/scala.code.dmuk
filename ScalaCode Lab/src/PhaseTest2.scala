...
object PhaseTest2 {
  def main(args: Array[String]): Unit = {
    ...
    //    Character filter (if Upper Case):
    ...
    // Yield statement usage with two string:
    ...
    // Alternative way of using the yield statement (multiparameter for)
    val nouns = List("apple", "banana", "orange")
    val adjectives = List("red", "yellow", "orange")
    ...
    val colours = Array[String]("red", "blue", "yellow", "black")
    val vehicles = Array[String]("car", "bus", "van", "plane")

    val compound = for (colour <- colours; )
